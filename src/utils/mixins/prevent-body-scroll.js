...
const BODY_CLASS_NAME = 'ui-modal-open'
const CONTAINER_CLASS_NAME = 'ui-modal-open-for-container'
const UI_VIEW_BOX_ELEMENT = '#ui_view_box_body'
  ...
  methods: {
    ...
    addModalClassName() {
      ...
      if (this.getLayout() === 'VIEW_BOX') {
        ...
        dom.addClass(document.querySelector(UI_VIEW_BOX_ELEMENT), CONTAINER_CLASS_NAME)
      }
    },
    removeModalClassName() {
      if (this.getLayout() === 'VIEW_BOX') {
        dom.removeClass(document.body, BODY_CLASS_NAME)
        dom.removeClass(document.querySelector(UI_VIEW_BOX_ELEMENT), CONTAINER_CLASS_NAME)
      }
    }
  },
  beforeDestroy() {
