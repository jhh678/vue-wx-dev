;(function(window) {
  ...
  var members = {
    ...
    */
     ...
     */
    doTouchMove: function(touches, timeStamp, scale, callback) {
      // Array-like check is enough here
      if (touches.length == null) {
        throw new Error('Invalid touch list: ' + touches)
      }
      ...
      callback &&
        callback({
          currentTouchLeft: currentTouchLeft,
          currentTouchTop: currentTouchTop,
          scale: scale
        })
    },
    ...
    */
    ...
    __computeScrollMax: function(zoomLevel) {
      ...
      self.__maxScrollTop = Math.max(
        self.__contentHeight * zoomLevel - self.__clientHeight - self.__refreshHeight,
        0
      )
    },
...
export default window.Scroller
